 ...
 */
final class Version20240218144532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rapport ADD CONSTRAINT FK_BE34A09C3CB3B7C6 FOREIGN KEY (idR) REFERENCES rendezvous (id_r)');
